...
import { GiftCodeRow, addMonths, clampTimeInputPart, formatDateOnlyInputValue, formatDateTimeButtonLabel, formatMonthLabel, getDateInputPart, getMonthIndex, getTimeInputPart, isBeforeDay, isSameDay, parseDateTimeInputValue, startOfCalendarWeek, startOfMonth } from "./shared-part-01";
...
export function targetUserLabel(value: GiftCodeRow["target_user_type"]): string {
  if (value === "premium") {
...
export function statusLabel(status: GiftCodeRow["status"]): string {
  if (status === "revoked") {
    return "Disabled";
  }
  return status;
