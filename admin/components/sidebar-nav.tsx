...
export function SidebarNav({
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          "fixed inset-y-0 left-0 z-50 flex flex-col border-r border-border bg-card transition-all duration-300 lg:sticky lg:top-0 lg:z-auto lg:h-screen",
          collapsed ? "w-20" : "w-64",
                    ...
                    return (
                      ...
                      >
                        <div className={cn("flex items-center", collapsed ? "justify-center" : "gap-3.5")}>
                          {Icon ? <Icon className={cn("h-5 w-5", active ? "opacity-100" : "opacity-70")} /> : null}
