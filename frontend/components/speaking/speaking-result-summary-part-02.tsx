...
import { ArrowRight, CalendarDays, CheckCircle2, Clock3, Info, Lightbulb, Link, ListOrdered, Mic2, PolarAngleAxis, PolarGrid, PolarRadiusAxis, Radar, RadarChart, RefreshCcw, ResponsiveContainer, Star, Tooltip, Users, bandProgressPercent, bandToCefr, cn, formatResultDate, formatSpeakingBand, formatSpeakingDuration, formatSpeakingPartLabel, getScoreHeadline, getScoreSubtext, pickImprovementText, pickStrengthText, resolveSpeakingQuestionsAnswered, roundIeltsBand } from "./speaking-result-summary-dependencies";
import { CRITERIA, SpeakingResultSummaryProps } from "./speaking-result-summary-part-01";
import { CriterionCard, FeedbackBlock, MetaCell } from "./speaking-result-summary-part-03";
...
export function BandScoreRing({ band }: { band: number | null }) {
  const size = 176;
  const radius = 70;
  const stroke = 11;
