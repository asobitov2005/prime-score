...
import { BookOpen, CalendarDays, LayoutDashboard, Menu, Moon, Sun, User, LogOut, ChevronDown, Settings2, Bell, Headphones, PenSquare, Mic } from "lucide-react";
...
export function SiteShell({ children }: SiteShellProps) {
  ...
  const openMobileSidebar = useUIStore((state) => state.setMobileSidebarOpen);
        ...
        >
          {isAppRoute ? (
            <div className="flex min-w-0 items-center gap-1.5 lg:hidden">
              <Link href="/" className="flex h-10 min-w-0 shrink -translate-y-0.5 items-center gap-2 rounded-xl">
