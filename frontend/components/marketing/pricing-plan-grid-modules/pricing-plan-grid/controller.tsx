...
export function usePricingPlanGridController(props: PricingPlanGridProps) {
...
export type PricingPlanGridScope = ReturnType<typeof usePricingPlanGridController>;
