...
import { Howl, emitNotificationRefresh, fetchInternalUserApi, trackAttemptSubmit, useEffect, useRef, useRouter, useState, useUIStore } from "../dependencies";

export function useControllerPart1(scope: BaseScope) {
  const { attemptId, testTitle, mode, scope, part, meta, initialAnswers } = scope;
  ...
  return { attemptApiBaseUrl, router, activeAttemptTab, setActiveAttemptTab, activeSegment, setActiveSegment, answers, setAnswers, saveState, setSaveState, isSubmitting, setIsSubmitting, timeLeft, setTimeLeft, initialAnswersKey, isPlaying, setIsPlaying, progress, setProgress, howlRef, persistAnswer };
}
