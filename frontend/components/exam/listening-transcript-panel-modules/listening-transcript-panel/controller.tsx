...
export function useListeningTranscriptPanelController(props: ListeningTranscriptPanelProps) {
...
export type ListeningTranscriptPanelScope = ReturnType<typeof useListeningTranscriptPanelController>;
